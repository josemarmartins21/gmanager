...
use App\Http\Controllers\MarkSaleAsPaidController;
...
Route::middleware('auth')->group(function() {
    Route::patch('sale-status/{sale}', MarkSaleAsPaidController::class)->name('sale-status')
    ->middleware('can:alterar status da venda');
