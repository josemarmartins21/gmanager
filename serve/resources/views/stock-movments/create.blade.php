    ...
    <section id="index-container">
       <x-dashboard.content class="md:bg-white md:dark:bg-[var(--dark-fundo-card)] md:p-5">
            ...
            <x-dashboard.input-container>
                ...
                <x-dashboard.input-select name="type">
                    ...
                    @foreach ($allowedOperations as $operations)
                        ...
                        {{ old('type') == $operations->value ? 'selected' : '' }}
                        > 
                        {{ $operations->value }} 
                        </option>
                    @endforeach
            ...
            <x-dashboard.input-container>
                ...
                <x-dashboard.form-input type="number" name="total_units" id="total_units" placeholder="Quantidade *"></x-dashboard.form-input>
            ...
            <x-dashboard.input-container>
                ...
                <x-dashboard.form-input type="number" value="{{ old('units_per_box') }}" name="units_per_box" id="units_per_box" placeholder="Total em cada caixa *" min="3"></x-dashboard.form-input>
            ...
            <x-dashboard.input-container>
                ...
                <x-dashboard.form-input type="number" value="{{ old('box_qty') }}" name="box_qty" id="box_qty" placeholder="Nª de Caixas/Grade" min="1"></x-dashboard.form-input>
